...
const orderDetails = [
   {
      ...
      detailedDescription:
         "This is a descriptive description of project lorThis is a descriptive description of project lor",
      Amount: "250",
      phone: "+91998365478",
...
function DeveloperOrders() {
   ...
   return (
      <>
         <Typography variant="h6" sx={{ fontWeight: "800", py: 1 }}>
            Orders details
         </Typography>
         <div>
